...
const LANGUAGE_LABELS = {
  ru: {
    ...
    withdrawRequestTitle: 'Запрос на вывод средств',
    withdrawRequestText: 'Внимание!\nВывод средств осуществляется только на реквизиты, с которых было выполнено последнее пополнение баланса.\n\nСредства поступят в течение 15 минут после оформления заявки.',
  ...
  en: {
    ...
    withdrawRequestTitle: 'Withdrawal request',
    withdrawRequestText: 'Attention!\nWithdrawals are sent only to the payment details used for the most recent balance top-up.\n\nFunds will arrive within 15 minutes after the request is submitted.',
